...
const HI = {
  ...
  'Version': 'Version',
  /* ---------- the journey ---------- */
  'days trained': 'din train kiya',
  '1 day trained': '1 din train kiya',
  'more to': 'aur',
  'Every place reached.': 'Har jagah pahunch gaye.',
  'Your Starting Point': 'Aapki shuruaat',
  'Set it': 'Set karo',
  'Change it': 'Badlo',
  'Muscle': 'Muscle',
  'more days of training': 'din aur training',
  '1 more day of training': '1 din aur training',
  'You reached the summit': 'Aap choti pe pahunch gaye',
  'List view': 'List mein dekho',
  'How it works': 'Yeh kaise chalta hai',
  'Every day you train counts, in any order. Rest days take nothing away. Reach 360 days of training and you reach the summit — it does not matter whether that takes a year or three.':
    'Har din jo aap train karte ho woh ginta hai, kisi bhi kram mein. Aaram ke din kuch nahi cheenrte. 360 din training karo aur choti pe pahunch jao — chahe ek saal lage ya teen.',
  'Record your progress': 'Apni progress likho',
  'Save progress': 'Progress save karo',
  'Could not save': 'Save nahi hua',
  'Notes': 'Notes',
  'How are you feeling?': 'Kaisa mehsoos ho raha hai?',
  'Where you began.': 'Yahan se shuru kiya.',
  'Reached.': 'Pahunch gaye.',
  'Map': 'Map',
  'DAY': 'DIN',
  'BRONZE': 'BRONZE', 'SILVER': 'SILVER', 'GOLD': 'GOLD', 'DIAMOND': 'DIAMOND',
  'bronze': 'bronze', 'silver': 'silver', 'gold': 'gold', 'diamond': 'diamond',
  'First Camp': 'Pehla Camp',
  'The Crossing': 'Paar',
  'Old Mill': 'Purani Chakki',
  'Riverbend': 'Nadi Mod',
  'The Falls': 'Jharna',
  'Watchtower': 'Meenar',
  'Hollow Pass': 'Khali Ghati',
  'The Deepwood': 'Gehra Jungle',
  'Emberfall': 'Angaar',
  'The Forge': 'Bhatti',
  'Snowline': 'Barf Rekha',
  'The Spire': 'Shikhar',
  ...
  /* ---------- compete ---------- */
  'vs All': 'vs Sab',
  'seconds, who can do max reps?': 'second, sabse zyada reps kaun karega?',
  'Stranger': 'Anjaan',
  'Exercise': 'Exercise',
  'TARGET': 'TARGET', 'DURATION': 'DURATION', 'COUNTING': 'GINTI',
  'Max Reps': 'Max Reps', 'Longest': 'Sabse lamba',
  'Seconds': 'Second', 'Camera': 'Camera', 'Tap': 'Tap',
  'Find someone': 'Koi dhoondo',
  'Give up': 'Chhod do',
  'YOUR REPS': 'AAPKE REPS',
  'Counting…': 'Gin raha hai…',
  'OPPONENT': 'SAAMNE WALA',
  'TIME LEFT': 'TIME BACHA',
  'Tap the screen for each rep.': 'Har rep pe screen tap karo.',
  'Sit-ups': 'Sit-ups', 'Plank': 'Plank', 'Burpees': 'Burpees',
};
